    ...
    <main class="flex-shrink-0">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
            <div class="container px-5">
                <a class="navbar-brand" href="{{ url('/') }}"><span class="fw-bolder text-primary">Zaynal
                        Abedin</span></a>
                        ...
                        <div class="col-lg-8 col-xl-6">
                            ...
                            <form action="{{ route('contact-store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <input type="textarea" name="fullName" value="{{ old('fullName') }}"
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <textarea type="text" name="message" id="" cols="30" rows="10" placeholder="Enter Your Message"
    ...
    <footer class="bg-white py-4 mt-auto">
        <div class="container px-5">
            <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                <div class="col-auto">
                    <div class="small m-0">Copyright &copy; Zaynal Abedin 2023</div>
                </div>
                <div class="col-auto">
